 ...
 * @ORM\Entity(repositoryClass="BayardTest\PlatformBundle\Repository\AdvertRepository")
 */
class Advert
{
    /**
    ...
    */
     ...
     * Set image.
     *
     * @param \BayardTest\PlatformBundle\Entity\Image $image
     *
     * @return Advert
     */
    public function setImage(\BayardTest\PlatformBundle\Entity\Image $image =  null)
    {
        $this->image = $image;
